...
Technique::Technique(size_t channels) : channels{ channels } {}

Technique::Technique(std::string name, size_t channels, bool startActive) noexcept : active(startActive), name(name), channels(channels) {}
