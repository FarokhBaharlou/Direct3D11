...
Graphics::Graphics(HWND hWnd)
{
	...
	//creat view of depth stencil texture
...
void Graphics::DrawTestTriangle(float angle, float x, float z)
{
	...
	//Creat constant buffer for transformations
	...
	{
		dx::XMMatrixTranspose(dx::XMMatrixRotationZ(angle) * dx::XMMatrixRotationX(angle) * dx::XMMatrixTranslation(x,0.0f,z + 4.0f) * dx::XMMatrixPerspectiveLH(1.0f,3.0f / 4.0f,0.5f,10.0f))
	};
